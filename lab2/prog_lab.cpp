...
// ********************************************************
	...
	//"указывают"
	{
		...
		bool *pB = &b; // *pB = 0x5ffd4f
		char *pC = &c; // *pC = 0x5ffd4e "q\001\002"
		short *pS = &s; //*pS = 0x5ffd4c
		int *pI = &i; // *pI = 0x5ffd48
		float *pf = &f; // *pf = 0x5ffd44
		double *pD = &d; // *pD = 0x5ffd38

        // Итог: в значения переменных-указателей будут переданы адреса (ссылки) переменных разных типов, созданных ранее
