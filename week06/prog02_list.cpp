/*
Программа №2 из Списка 04

Задача: объедиение двух векторов в единый с чередующимися элементами

Определение переменных:
n1 - длина вектора *a элементов типа (char)
n2 - длина вектора *b элементов типа (char)
n3 - длина объединённого вектора *z элементов типа (char)
*a - вектор элементов типа (char)
*b - вектор элементов типа (char)
*z - вектор элементов типа (char) с чередующимися элементами векторов *a и *b
*/
